            ...
            <div className="modern-card-body" style={{ textAlign: 'center', padding: '48px 24px' }}>
                ...
                >
                    ...
                    <p className="modern-text" style={{ fontSize: '16px', lineHeight: '1.6' }}>
                        Streamline your fiber installation projects with our comprehensive management platform. From planning to
                        completion, manage every aspect of your fiber network deployment.
                    </p>
                </div>
                <div
                    style={{
                ...
                >
                    ...
                    <div
                        className="status-indicator scheduled"
                        style={{
                            padding: '16px',
                            borderRadius: '12px',
