...
const AdminDistrictManagementPage: React.FC = () => {
    ...
    const fetchDashboardData = async (): Promise<void> => {
        try {
            const response = await axiosPrivate.get<DashboardData>('/api/dashboard/stats');
    ...
    const onDragEnd = async (result: DropResult): Promise<void> => {
        ...
        try {
            ...
            logger.error('Failed to update priorities', err);
            fetchAllDistricts();
        } finally {
            setIsSaving(false);
        }
    ...
    const ProcessFlowDiagram: React.FC = () => (
        <div className="process-flow-container">
            <h2 className="process-flow-title">Fiber Installation Process Overview</h2>
            ...
            <div className="overall-progress">
                <div className="overall-progress-title">Overall Installation Progress</div>
                ...
                <div className="overall-progress-text">
                    {dashboardData.totalFlats > 0
                        ? Math.round((dashboardData.completedInstallations / dashboardData.totalFlats) * 100)
                        : 0}
                    % Complete ({dashboardData.completedInstallations} of {dashboardData.totalFlats} apartments)
                </div>
            </div>
        </div>
    );
            ...
            <div className="district-management-section">
                ...
                <div className="instructions-card">
                    ...
                    <div className="instructions-content">
                        ...
                        <p>
                            Drag and drop districts to reorder their priority. The first district gets the highest priority for
                ...
                {isSaving && <div className="saving-message">Saving priority changes...</div>}
                    ...
                    <DragDropContext onDragEnd={onDragEnd}>
                        <Droppable droppableId="districts">
                            {(provided: DroppableProvided) => (
                                <div {...provided.droppableProps} ref={provided.innerRef} className="districts-container">
                                                ...
                                                >
                                                    <div className="district-header">
                                                        ...
                                                        <div className="district-priority">
                                                            <span className="priority-icon">🎯</span>#{index + 1}
                                                            ...
                                                            <div
                                                                ...
                                                                style={{
                                                                    ...
                                                                    backgroundColor: getProgressBarColor(
                                                                        district.stats?.completionPercentage || 0
                                                                    ),
                                                                }}
                                                            />
                                                        </div>
