...
type RoleTab = 'all' | 'Admin' | 'TechnischePlanning' | 'TechnischeSchouwer' | 'Werkvoorbereider' | 'HASPlanning' | 'HASMonteur';
...
const Users: React.FC = () => {
    ...
    const getUserRole = (rolesObj: UserRoles | undefined): string => {
